...
<head>
  ...
  <title><?= $_SESSION['app_name'] ?> - Tambah Data Produksi Ikan</title>
		...
		<!-- Main Content -->
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<div class="clearfix">
						<h1 class="h3 mb-4 text-gray-800 float-left">Tambah Data Produksi Ikan</h1>
									...
									<form action="proses_tambah.php" method="POST">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="nama_produksi" class="form-control" placeholder="Masukan Nama Produksi" name="nama_produksi" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="penanggung_jawab" class="form-control" placeholder="Masukan Penanggung Jawab" name="penanggung_jawab" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="letak_produksi" class="form-control" placeholder="Masukan Letak Produksi" name="letak_produksi" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
