...
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * FROM t_sampah WHERE id = $id");
$sampah = mysqli_fetch_assoc($query);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title><?= $_SESSION['app_name'] ?> - Ubah Data Sampah </title>
		...
		<!-- Main Content -->
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<div class="clearfix">
						<h1 class="h3 mb-4 text-gray-800 float-left">Ubah Data Sampah</h1>
					...
					<div class="row">
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-body">
									<form action="proses_ubah.php?id=<?php echo $sampah['id'] ?>" method="POST">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="number" id="jumlah_sampah2" class="form-control" placeholder="Masukan Jumlah Sampah Dalam Kg" name="jumlah_sampah2" autocomplete="off" required="required" value="<?php echo $sampah['jumlah_sampah'] ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="jenis_sampah2" class="form-control" placeholder="Masukan Jenis Sampah" name="jenis_sampah2" autocomplete="off" required="required" value="<?php echo $sampah['jenis_sampah'] ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<select name="hari_pembersihan2" id="hari_pembersihan2" class="form-control">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="date" id="tanggal_pembersihan2" class="form-control" placeholder="Masukan Tanggal Pembersihan" name="tanggal_pembersihan2" autocomplete="off" required="required" value="<?php echo $sampah['tanggal_pembersihan'] ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<textarea name="pngjawab2" id="pngjawab2" class="form-control" placeholder="Masukan Nama Penanggung Jawab" required="required" autocomplete="off"><?php echo $sampah ['pngjawab']; ?></textarea>
											</div>
										</div>
										<div class="form-group">
