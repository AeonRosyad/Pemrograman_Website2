...
<head>
  ...
  <title><?= $_SESSION['app_name'] ?> - Tambah Data Terumbu Karang</title>
		...
		<!-- Main Content -->
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<div class="clearfix">
						<h1 class="h3 mb-4 text-gray-800 float-left">Tambah Data Terumbu Karang</h1>
									...
									<form action="proses_tambah.php" method="POST">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="nama_trbkarang" class="form-control" placeholder="Masukan Nama trbkarang" name="nama_trbkarang" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
											<label for="jumlah_trbkarang">Jumlah trbkarang </label>
											<div class="input-group">
												<div class="input-group-prepend">
													<div class="input-group-text"><i class="fas fa-at"></i></div>
												</div>
												<input type="number" id="jumlah_trbkarang" class="form-control" placeholder="Masukan Jumlah trbkarang" name="jumlah_trbkarang" autocomplete="off" required="required">
											</div>
										</div>
										<div class="form-group">
